...
describe('AccountStore', () => {
  ...
  it('should set account info', async () => {
    ...
    expect(accountStore.getAccountInfo(network, address).accountInfo).toEqual(accountInfo);
  });
  ...
  it('should set and get transactions', async () => {
    ...
    expect(accountStore.getTransactions(network, address)).toEqual(transactions.pageResults);
  });

  it('should add an account', () => {
    const accountStore = new AccountStore();
    accountStore.addAccount(network, address);
    expect(accountStore.getAccountInfo(network, address)).toEqual(initialSingleAccountState);
  });
